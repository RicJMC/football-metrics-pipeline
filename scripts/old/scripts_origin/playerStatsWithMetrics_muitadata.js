...
for (const metrica in METRICAS) {
 ...
 const outputFilename = filename.replace('.json', 'WithMetrics.json');
...
const filesToProcess = ['playerStatsWithZScores_0.json', 'playerStatsWithZScores_1.json', 'playerStatsWithZScores_2.json'];
